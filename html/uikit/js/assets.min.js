!function (t) {
    ...
    function i(i) {
        ...
        if (s.length && !(e.scrollTop() < 0))for (var a, r, p, h, c = e.scrollTop(), l = n.height(), u = e.height(), d = l - u, m = c > d ? d - c : 0, f = 0; f < s.length; f++)if (h = s[f], h.element.is(":visible") && !h.animate) {
            if (h.check()) {
                ...
                if (h.currentTop != a) {
                    if (h.element.css({
                            position: "fixed",
                            top: a,
                            width: "undefined" != typeof h.getWidthFrom ? t.$(h.getWidthFrom).width() : h.element.width(),
                        ...
                        w.length && setTimeout(function (t, i) {
                            return function () {
                                ...
                                o.top < n && e.top < a && (c = e.top - s - i.options.target, window.scrollTo(0, c))
                            }
                        }(w, h), 0)
                    }
    ...
    return t.component("sticky", {
        defaults: {
            ...
            var i, a = t.$('<div class="uk-sticky-placeholder"></div>'), r = this.options.boundary;
...
!function (t) {
    ...
    function i(i) {
        ...
        if (e.is(":visible"))o = e.outerHeight(); else {
            var n = {position: e.css("position"), visibility: e.css("visibility"), display: e.css("display")};
            o = e.css({position: "absolute", visibility: "hidden", display: "block"}).outerHeight(), e.css(n)
        }
        return o
    }
    ...
    return t.component("accordion", {
        defaults: {
            ...
            n && (this.toggle.not(e.data("toggle")).removeClass(this.options.clsactive), this.content.not(e.data("content")).parent().stop().css("overflow", "hidden").animate({height: 0}, {
                easing: this.options.easing,
                duration: o ? this.options.duration : 0
            }).attr("aria-expanded", "false")), e.stop().css("overflow", "hidden"), o ? e.animate({height: a ? i(e.data("content")) : 0}, {
                easing: this.options.easing,
            ...
            }) : (e.height(a ? "auto" : 0), a && (e.css({overflow: ""}), t.Utils.checkDisplay(e.data("content"))), this.trigger("display.uk.check")), e.attr("aria-expanded", a), this.element.trigger("toggle.uk.accordion", [a, e.data("toggle"), e.data("content")])
        }, update: function () {
            var i, e, o, n = this;
    ...
    return t.component("tooltip", {
        defaults: {
            ...
            if (this.tip = "function" == typeof this.options.src ? this.options.src(this.element) : this.options.src, e && clearTimeout(e), o && clearTimeout(o), "string" == typeof this.tip ? this.tip.length : 0) {
                ...
                }), a = i[0].offsetWidth, r = i[0].offsetHeight, l = "function" == typeof this.options.offset ? this.options.offset.call(this.element) : this.options.offset, p = "function" == typeof this.options.pos ? this.options.pos.call(this.element) : this.options.pos, c = p.split("-"), h = {
                    display: "none",
                    visibility: "visible",
                ...
                if ("fixed" == t.$html.css("position") || "fixed" == t.$body.css("position")) {
                    var d = t.$("body").offset(), f = t.$("html").offset(), u = {
                        top: f.top + d.top,
                        left: f.left + d.left
                    };
                    s.left -= u.left, s.top -= u.top
                }
                ...
                t.$.extend(h, m[c[0]]), 2 == c.length && (h.left = "left" == c[1] ? s.left : s.left + s.width - a);
                var g = this.checkBoundary(h.left, h.top, a, r);
                if (g) {
                    switch (g) {
                        case"x":
                            p = 2 == c.length ? c[0] + "-" + (h.left < 0 ? "left" : "right") : h.left < 0 ? "right" : "left";
                            break;
                        case"y":
                            p = 2 == c.length ? (h.top < 0 ? "bottom" : "top") + "-" + c[1] : h.top < 0 ? "bottom" : "top";
                            break;
                        case"xy":
                            p = 2 == c.length ? (h.top < 0 ? "bottom" : "top") + "-" + (h.left < 0 ? "left" : "right") : h.left < 0 ? "right" : "left"
                    }
                    c = p.split("-"), t.$.extend(h, m[c[0]]), 2 == c.length && (h.left = "left" == c[1] ? s.left : s.left + s.width - a)
                }
                h.left -= t.$body.position().left, e = setTimeout(function () {
                    i.css(h).attr("class", ["uk-tooltip", "uk-tooltip-" + p, n.options.cls].join(" ")), n.options.animation ? i.css({
                        opacity: 0,
                        display: "block"
                    }).addClass(n.options.activeClass).animate({opacity: 1}, parseInt(n.options.animation, 10) || 400) : i.show().addClass(n.options.activeClass), e = !1, o = setInterval(function () {
                        n.element.is(":visible") || n.hide()
                    }, 150)
                }, parseInt(this.options.delay, 10) || 0)
            }
        }, hide: function () {
            if (!this.element.is("input") || this.element[0] !== document.activeElement)if (e && clearTimeout(e), o && clearTimeout(o), i.stop(), this.options.animation) {
                var t = this;
...
!function (t) {
    ...
    var e = function () {
        ...
        return function () {
            if (!e || !e.requirejs) {
                ...
                !function (e) {
                    ...
                    function s(t, e) {
                        var n, i, o, s, r, a, l, c, u, p, d, h = e && e.split("/"), f = y.map, g = f && f["*"] || {};
                        if (t && "." === t.charAt(0))if (e) {
                            for (t = t.split("/"), r = t.length - 1, y.nodeIdCompat && _.test(t[r]) && (t[r] = t[r].replace(_, "")), t = h.slice(0, h.length - 1).concat(t), u = 0; u < t.length; u += 1)if (d = t[u], "." === d)t.splice(u, 1), u -= 1; else if (".." === d) {
                        ...
                        if ((h || g) && f) {
                            for (n = t.split("/"), u = n.length; u > 0; u -= 1) {
                                if (i = n.slice(0, u).join("/"), h)for (p = h.length; p > 0; p -= 1)if (o = f[h.slice(0, p).join("/")], o && (o = o[i])) {
                                    s = o, a = u;
                                    break
                                }
                                if (s)break;
                    ...
                    var d, h, f, g, m = {}, v = {}, y = {}, w = {}, b = Object.prototype.hasOwnProperty, $ = [].slice, _ = /\.js$/;
                    f = function (t, e) {
                        var n, i = u(t), o = i[0];
                        return t = i[1], o && (o = s(o, e), n = c(o)), o ? t = n && n.normalize ? n.normalize(t, a(e)) : s(t, e) : (t = s(t, e), i = u(t), o = i[0], t = i[1], o && (n = c(o))), {
                            f: o ? o + "!" + t : t,
                            n: t,
                            pr: o,
                            p: n
                        ...
                        var a, u, p, d, h, y, b = [], $ = typeof i;
                        if (s = s || t, "undefined" === $ || "function" === $) {
                            for (n = !n.length && i.length ? ["require", "exports", "module"] : n, h = 0; h < n.length; h += 1)if (d = f(n[h], s), u = d.f, "require" === u)b[h] = g.require(t); else if ("exports" === u)b[h] = g.exports(t), y = !0; else if ("module" === u)a = b[h] = g.module(t); else if (o(m, u) || o(v, u) || o(w, u))b[h] = c(u); else {
                                if (!d.p)throw new Error(t + " missing " + u);
                                d.p.load(d.n, r(s, !0), l(u), {}), b[h] = m[u]
                            }
                        ...
                        return n = n || function () {
                            }, "function" == typeof i && (i = o, o = s), o ? d(e, t, n, i) : setTimeout(function () {
                            d(e, t, n, i)
                        }, 4), h
                    }, h.config = function (t) {
                        return h(t)
            ...
            return e.Extend(n, e.Observable), n.prototype.render = function () {
                ...
                var i = t('<li role="treeitem" aria-live="assertive" class="select2-results__option"></li>'), o = this.options.get("translations").get(e.message);
                ...
                this.$results.attr("id", o), e.on("results:all", function (t) {
                    ...
                    if (!(o >= e.length)) {
                        var s = e.eq(o);
                        s.trigger("mouseenter");
                        var r = i.$results.offset().top + i.$results.outerHeight(!1), a = s.offset().top + s.outerHeight(!1), l = i.$results.scrollTop() + a - r;
                    ...
                    var e = i.$results.scrollTop(), n = i.$results.get(0).scrollHeight - i.$results.scrollTop() + t.deltaY, o = t.deltaY > 0 && e - t.deltaY <= 0, s = t.deltaY < 0 && n <= i.$results.height();
                ...
                if (0 !== t.length) {
                    var e = this.$results.find("[aria-selected]"), n = e.index(t), i = this.$results.offset().top, o = t.offset().top, s = this.$results.scrollTop() + (o - i), r = o - i;
            ...
            return e.Extend(i, t), i.prototype.select = function (t) {
                ...
                for (var o = this, s = this.$element.find("option"), r = s.map(function () {
                    ...
                    if (n.inArray(c.id, r) >= 0) {
                        var u = s.filter(i(c)), p = this.item(u), d = n.extend(!0, {}, p, c), h = this.option(d);
                        u.replaceWith(h)
                    } else {
                        var f = this.option(c);
                        if (c.children) {
            ...
            return e.Extend(i, t), i.prototype._applyDefaults = function (t) {
                ...
                "function" == typeof s.url && (s.url = s.url.call(this.$element, t)), "function" == typeof s.data && (s.data = s.data.call(this.$element, t)), this.ajaxOptions.delay && "" !== t.term ? (this._queryTimeout && window.clearTimeout(this._queryTimeout), this._queryTimeout = window.setTimeout(i, this.ajaxOptions.delay)) : i()
            }, i
        }), e.define("select2/data/tags", ["jquery"], function (t) {
            function e(e, n, i) {
                var o = i.get("tags"), s = i.get("createTag");
                if (void 0 !== s && (this.createTag = s), e.call(this, n, i), t.isArray(o))for (var r = 0; r < o.length; r++) {
            ...
            return e.prototype.query = function (t, e, n) {
                function i(t, s) {
                    for (var r = t.results, a = 0; a < r.length; a++) {
                        var l = r[a], c = null != l.children && !i({results: l.children}, !0), u = l.text === e.term;
                        if (u || c)return s ? !1 : (t.data = r, void n(t))
                    }
                    if (s)return !0;
                    var p = o.createTag(e);
                    if (null != p) {
                        var d = o.option(p);
                        d.attr("data-select2-tag", !0), o.addOptions([d]), o.insertTag(r, p)
                    }
                    t.results = r, n(t)
                }
            ...
            return e.prototype.bind = function (t, e, n) {
                ...
                for (var s = i.get("tokenSeparators") || [], r = n.term, a = 0, l = this.createTag || function (t) {
                    ...
                    var c = r[a];
                    if (-1 !== t.inArray(c, s)) {
                        var u = r.substr(0, a), p = t.extend({}, n, {term: u}), d = l(p);
            ...
            return e.prototype.append = function (t, e) {
                ...
                var e = t('<li class="select2-results__option select2-results__option--load-more"role="treeitem" aria-disabled="true"></li>'), n = this.options.get("translations").get("loadingMore");
            ...
            return n.prototype.bind = function (t, e, n) {
                ...
                var o = this, s = "scroll.select2." + i.id, r = "resize.select2." + i.id, a = "orientationchange.select2." + i.id, l = this.$container.parents().filter(e.hasScroll);
                l.each(function () {
                ...
                var o = "scroll.select2." + i.id, s = "resize.select2." + i.id, r = "orientationchange.select2." + i.id, a = this.$container.parents().filter(e.hasScroll);
                a.off(o), t(window).off(o + " " + s + " " + r)
            }, n.prototype._positionDropdown = function () {
                var e = t(window), n = this.$dropdown.hasClass("select2-dropdown--above"), i = this.$dropdown.hasClass("select2-dropdown--below"), o = null, s = (this.$container.position(), this.$container.offset());
        ...
        }), e.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function (t, e, n, i, o, s, r, a, l, c, u, p, d, h, f, g, m, v, y, w, b, $, _, x, A, C, k, T, E) {
            function O() {
                this.reset()
            }
            ...
            O.prototype.apply = function (p) {
                if (p = t.extend({}, this.defaults, p), null == p.dataAdapter) {
                    if (null != p.ajax ? p.dataAdapter = f : null != p.data ? p.dataAdapter = h : p.dataAdapter = d, p.minimumInputLength > 0 && (p.dataAdapter = c.Decorate(p.dataAdapter, v)), p.maximumInputLength > 0 && (p.dataAdapter = c.Decorate(p.dataAdapter, y)), p.maximumSelectionLength > 0 && (p.dataAdapter = c.Decorate(p.dataAdapter, w)), p.tags && (p.dataAdapter = c.Decorate(p.dataAdapter, g)), (null != p.tokenSeparators || null != p.tokenizer) && (p.dataAdapter = c.Decorate(p.dataAdapter, m)), null != p.query) {
                        var E = e(p.amdBase + "compat/query");
                        p.dataAdapter = c.Decorate(p.dataAdapter, E)
                    }
                ...
                if (null == p.resultsAdapter && (p.resultsAdapter = n, null != p.ajax && (p.resultsAdapter = c.Decorate(p.resultsAdapter, x)), null != p.placeholder && (p.resultsAdapter = c.Decorate(p.resultsAdapter, _)), p.selectOnClose && (p.resultsAdapter = c.Decorate(p.resultsAdapter, k))), null == p.dropdownAdapter) {
                    if (p.multiple)p.dropdownAdapter = b; else {
                        var S = c.Decorate(b, $);
                        p.dropdownAdapter = S
                    }
                    if (0 !== p.minimumResultsForSearch && (p.dropdownAdapter = c.Decorate(p.dropdownAdapter, C)), p.closeOnSelect && (p.dropdownAdapter = c.Decorate(p.dropdownAdapter, T)), null != p.dropdownCssClass || null != p.dropdownCss || null != p.adaptDropdownCssClass) {
                        var D = e(p.amdBase + "compat/dropdownCss");
                        p.dropdownAdapter = c.Decorate(p.dropdownAdapter, D)
                    }
                    p.dropdownAdapter = c.Decorate(p.dropdownAdapter, A)
                }
                if (null == p.selectionAdapter) {
                    if (p.multiple ? p.selectionAdapter = o : p.selectionAdapter = i, null != p.placeholder && (p.selectionAdapter = c.Decorate(p.selectionAdapter, s)), p.allowClear && (p.selectionAdapter = c.Decorate(p.selectionAdapter, r)), p.multiple && (p.selectionAdapter = c.Decorate(p.selectionAdapter, a)), null != p.containerCssClass || null != p.containerCss || null != p.adaptContainerCssClass) {
                        var q = e(p.amdBase + "compat/containerCss");
                        p.selectionAdapter = c.Decorate(p.selectionAdapter, q)
                    }
                    p.selectionAdapter = c.Decorate(p.selectionAdapter, l)
                }
                if ("string" == typeof p.language)if (p.language.indexOf("-") > 0) {
                    var I = p.language.split("-"), j = I[0];
                    p.language = [p.language, j]
                } else p.language = [p.language];
                if (t.isArray(p.language)) {
                    var L = new u;
                    p.language.push("en");
                    for (var P = p.language, U = 0; U < P.length; U++) {
                        var H = P[U], R = {};
                        try {
                            R = u.loadPath(H)
                        } catch (M) {
                            try {
                                ...
                                p.debug && window.console && console.warn && console.warn('Select2: The language file for "' + H + '" could not be automatically loaded. A fallback will be used instead.');
                                continue
                            }
                        }
                        L.extend(R)
                    ...
                    var W = u.loadPath(this.defaults.amdLanguageBase + "en"), N = new u(p.language);
                    N.extend(W), p.translations = N
                }
                return p
...
!function (t) {
    ...
    function e(e) {
        var r = e || window.event, a = l.call(arguments, 1), c = 0, d = 0, p = 0, h = 0, f = 0, g = 0;
        if (e = t.event.fix(r), e.type = "mousewheel", "detail" in r && (p = -1 * r.detail), "wheelDelta" in r && (p = r.wheelDelta), "wheelDeltaY" in r && (p = r.wheelDeltaY), "wheelDeltaX" in r && (d = -1 * r.wheelDeltaX), "axis" in r && r.axis === r.HORIZONTAL_AXIS && (d = -1 * p, p = 0), c = 0 === p ? d : p, "deltaY" in r && (p = -1 * r.deltaY, c = p), "deltaX" in r && (d = r.deltaX, 0 === p && (c = -1 * d)), 0 !== p || 0 !== d) {
            if (1 === r.deltaMode) {
            ...
            if (h = Math.max(Math.abs(p), Math.abs(d)), (!s || s > h) && (s = h, i(r, h) && (s /= 40)), i(r, h) && (c /= 40, d /= 40, p /= 40), c = Math[c >= 1 ? "floor" : "ceil"](c / s), d = Math[d >= 1 ? "floor" : "ceil"](d / s), p = Math[p >= 1 ? "floor" : "ceil"](p / s), u.settings.normalizeOffset && this.getBoundingClientRect) {
                var y = this.getBoundingClientRect();
                f = e.clientX - y.left, g = e.clientY - y.top
            }
            return e.deltaX = d, e.deltaY = p, e.deltaFactor = s, e.offsetX = f, e.offsetY = g, e.deltaMode = 0, a.unshift(e, c, d, p), o && clearTimeout(o), o = setTimeout(n, 200), (t.event.dispatch || t.event.handle).apply(this, a)
        }
    }
...
!function (t) {
    ...
    t.fn.jScrollPane = function (e) {
        function n(e, n) {
            function i(n) {
                var s, a, c, u, p, f, g = !1, m = !1;
                if (R = n, void 0 === z)p = e.scrollTop(), f = e.scrollLeft(), e.css({
                    overflow: "hidden",
                    padding: 0
                }), U = e.innerWidth() + vt, B = e.innerHeight(), e.width(U), z = t('<div class="jspPane" />').css("padding", mt).append(e.children()), W = t('<div class="jspContainer" />').css({
                    width: U + "px",
                    height: B + "px"
                }).append(z).appendTo(e); else {
                    if (e.css("width", ""), g = R.stickToBottom && A(), m = R.stickToRight && C(), u = e.innerWidth() + vt != U || e.outerHeight() != B, u && (U = e.innerWidth() + vt, B = e.innerHeight(), W.css({
                            width: U + "px",
                            height: B + "px"
                        })), !u && yt == Y && z.outerHeight() == N)return void e.width(U);
                    yt = Y, z.css("width", ""), e.width(U), W.find(">.jspVerticalBar,>.jspHorizontalBar").remove().end()
                }
                z.css("overflow", "auto"), Y = n.contentWidth ? n.contentWidth : z[0].scrollWidth, N = z[0].scrollHeight, z.css("overflow", ""), F = Y / U, X = N / B, K = X > 1, G = F > 1, G || K ? (e.addClass("jspScrollable"), s = R.maintainPosition && (Q || et), s && (a = x(), c = k()), o(), r(), l(), s && (_(m ? Y - U : a, !1), $(g ? N - B : c, !1)), E(), T(), L(), R.enableKeyboardNavigation && P(), R.clickOnTrack && d(), H(), R.hijackInternalLinks && I()) : (e.removeClass("jspScrollable"), z.css({
                    top: 0,
                    left: 0,
                    width: W.width() - vt
                }), D(), O(), q(), h()), R.autoReinitialise && !gt ? gt = setInterval(function () {
                    i(R)
                }, R.autoReinitialiseDelay) : !R.autoReinitialise && gt && clearInterval(gt), p && e.scrollTop(0) && $(p, !1), f && e.scrollLeft(0) && _(f, !1), e.trigger("jsp-initialised", [G || K])
            }

            function o() {
                K && (W.append(t('<div class="jspVerticalBar" />').append(t('<div class="jspCap jspCapTop" />'), t('<div class="jspTrack" />').append(t('<div class="jspDrag" />').append(t('<div class="jspDragTop" />'), t('<div class="jspDragBottom" />'))), t('<div class="jspCap jspCapBottom" />'))), nt = W.find(">.jspVerticalBar"), it = nt.find(">.jspTrack"), V = it.find(">.jspDrag"), R.showArrows && (at = t('<a class="jspArrow jspArrowUp" />').bind("mousedown.jsp", u(0, -1)).bind("click.jsp", S), lt = t('<a class="jspArrow jspArrowDown" />').bind("mousedown.jsp", u(0, 1)).bind("click.jsp", S), R.arrowScrollOnHover && (at.bind("mouseover.jsp", u(0, -1, at)), lt.bind("mouseover.jsp", u(0, 1, lt))), c(it, R.verticalArrowPositions, at, lt)), st = B, W.find(">.jspVerticalBar>.jspCap:visible,>.jspVerticalBar>.jspArrow").each(function () {
                    ...
                    t("html").bind("dragstart.jsp selectstart.jsp", S), V.addClass("jspActive");
                    var n = e.pageY - V.position().top;
            ...
            function s() {
                it.height(st + "px"), Q = 0, ot = R.verticalGutter + it.outerWidth(), z.width(U - ot - vt);
                try {
                    0 === nt.position().left && z.css("margin-left", ot + "px")
                } catch (t) {
                }
            }

            function r() {
                G && (W.append(t('<div class="jspHorizontalBar" />').append(t('<div class="jspCap jspCapLeft" />'), t('<div class="jspTrack" />').append(t('<div class="jspDrag" />').append(t('<div class="jspDragLeft" />'), t('<div class="jspDragRight" />'))), t('<div class="jspCap jspCapRight" />'))), ct = W.find(">.jspHorizontalBar"), ut = ct.find(">.jspTrack"), J = ut.find(">.jspDrag"), R.showArrows && (ht = t('<a class="jspArrow jspArrowLeft" />').bind("mousedown.jsp", u(-1, 0)).bind("click.jsp", S), ft = t('<a class="jspArrow jspArrowRight" />').bind("mousedown.jsp", u(1, 0)).bind("click.jsp", S), R.arrowScrollOnHover && (ht.bind("mouseover.jsp", u(-1, 0, ht)), ft.bind("mouseover.jsp", u(1, 0, ft))), c(ut, R.horizontalArrowPositions, ht, ft)), J.hover(function () {
                    J.addClass("jspHover")
                }, function () {
                    J.removeClass("jspHover")
                }).bind("mousedown.jsp", function (e) {
                    t("html").bind("dragstart.jsp selectstart.jsp", S), J.addClass("jspActive");
            ...
            function l() {
                if (G && K) {
                    ...
                    st -= e, t(ct).find(">.jspCap:visible,>.jspArrow").each(function () {
                        pt += t(this).outerWidth()
                    }), pt -= n, B -= n, U -= e, ut.parent().append(t('<div class="jspCorner" />').css("width", e + "px")), s(), a()
                }
                G && z.width(W.outerWidth() - vt + "px"), N = z.outerHeight(), X = N / B, G && (dt = Math.ceil(1 / F * pt), dt > R.horizontalDragMaxWidth ? dt = R.horizontalDragMaxWidth : dt < R.horizontalDragMinWidth && (dt = R.horizontalDragMinWidth), J.width(dt + "px"), tt = pt - dt, y(et)), K && (rt = Math.ceil(1 / X * st), rt > R.verticalDragMaxHeight ? rt = R.verticalDragMaxHeight : rt < R.verticalDragMinHeight && (rt = R.verticalDragMinHeight), V.height(rt + "px"), Z = st - rt, m(Q))
            }

            function c(t, e, n, i) {
                var o, s = "before", r = "after";
                "os" == e && (e = /Mac/.test(navigator.platform) ? "after" : "split"), e == s ? r = e : e == r && (s = e, o = n, n = i, i = o), t[s](n)[r](i)
            }
            ...
            function p(e, n, i, o) {
                ...
                var s, r, a = !0, l = function () {
                    0 !== e && wt.scrollByX(e * R.arrowButtonSpeed), 0 !== n && wt.scrollByY(n * R.arrowButtonSpeed), r = setTimeout(l, a ? R.initialDelay : R.arrowRepeatFreq), a = !1
                };
            ...
            function d() {
                h(), K && it.bind("mousedown.jsp", function (e) {
                    if (void 0 === e.originalTarget || e.originalTarget == e.currentTarget) {
                        var n, i = t(this), o = i.offset(), s = e.pageY - o.top - Q, r = !0, a = function () {
                            var t = i.offset(), o = e.pageY - t.top - rt / 2, c = B * R.scrollPagePercent, u = Z * c / (N - B);
                            if (0 > s)Q - u > o ? wt.scrollByY(-c) : g(o); else {
                                if (!(s > 0))return void l();
                                o > Q + u ? wt.scrollByY(c) : g(o)
                            }
                            n = setTimeout(a, r ? R.initialDelay : R.trackClickRepeatFreq), r = !1
                        }, l = function () {
                            n && clearTimeout(n), n = null, t(document).unbind("mouseup.jsp", l)
                        };
                        return a(), t(document).bind("mouseup.jsp", l), !1
                    }
                }), G && ut.bind("mousedown.jsp", function (e) {
                    if (void 0 === e.originalTarget || e.originalTarget == e.currentTarget) {
                        var n, i = t(this), o = i.offset(), s = e.pageX - o.left - et, r = !0, a = function () {
                            var t = i.offset(), o = e.pageX - t.left - dt / 2, c = U * R.scrollPagePercent, u = tt * c / (Y - U);
                            if (0 > s)et - u > o ? wt.scrollByX(-c) : v(o); else {
                                if (!(s > 0))return void l();
                                o > et + u ? wt.scrollByX(c) : v(o)
                            }
                            n = setTimeout(a, r ? R.initialDelay : R.trackClickRepeatFreq), r = !1
                        }, l = function () {
                            n && clearTimeout(n), n = null, t(document).unbind("mouseup.jsp", l)
            ...
            function g(n, i) {
                if (K) {
                    ...
                    if (e.trigger(o, [n]), !o.isDefaultPrevented()) {
                        var s = n || 0, r = 0 === s, a = s == Z, l = n / Z, c = -l * (N - B);
                        void 0 === i && (i = R.animateScroll), i ? wt.animate(V, "top", n, m, function () {
                            e.trigger("jsp-user-scroll-y", [-c, r, a])
                        }) : (V.css("top", n), m(n), e.trigger("jsp-user-scroll-y", [-c, r, a]))
                    }
                }
            }

            function m(t) {
                void 0 === t && (t = V.position().top), W.scrollTop(0), Q = t || 0;
                var n = 0 === Q, i = Q == Z, o = t / Z, s = -o * (N - B);
                (bt != n || _t != i) && (bt = n, _t = i, e.trigger("jsp-arrow-change", [bt, _t, $t, jt])), w(n, i), z.css("top", s), e.trigger("jsp-scroll-y", [-s, n, i]).trigger("scroll")
            }
            ...
            function v(n, i) {
                if (G) {
                    ...
                    if (e.trigger(o, [n]), !o.isDefaultPrevented()) {
                        var s = n || 0, r = 0 === s, a = s == tt, l = n / tt, c = -l * (Y - U);
                        void 0 === i && (i = R.animateScroll), i ? wt.animate(J, "left", n, y, function () {
                            e.trigger("jsp-user-scroll-x", [-c, r, a])
                        }) : (J.css("left", n), y(n), e.trigger("jsp-user-scroll-x", [-c, r, a]))
                    }
                }
            }

            function y(t) {
                void 0 === t && (t = J.position().left), W.scrollTop(0), et = t || 0;
                var n = 0 === et, i = et == tt, o = t / tt, s = -o * (Y - U);
                ($t != n || jt != i) && ($t = n, jt = i, e.trigger("jsp-arrow-change", [bt, _t, $t, jt])), b(n, i), z.css("left", s), e.trigger("jsp-scroll-x", [-s, n, i]).trigger("scroll")
            }

            function w(t, e) {
                R.showArrows && (at[t ? "addClass" : "removeClass"]("jspDisabled"), lt[e ? "addClass" : "removeClass"]("jspDisabled"))
            }

            function b(t, e) {
                R.showArrows && (ht[t ? "addClass" : "removeClass"]("jspDisabled"), ft[e ? "addClass" : "removeClass"]("jspDisabled"))
            }
            ...
            function j(e, n, i) {
                var o, s, r, a, l, c, u, p, d, h = 0, f = 0;
                try {
                    o = t(e)
                } catch (g) {
                    return
                }
                for (s = o.outerHeight(), r = o.outerWidth(), W.scrollTop(0), W.scrollLeft(0); !o.is(".jspPane");)if (h += o.position().top, f += o.position().left, o = o.offsetParent(), /^body|html$/i.test(o[0].nodeName))return;
                a = k(), c = a + B, a > h || n ? p = h - R.horizontalGutter : h + s > c && (p = h - B + s + R.horizontalGutter), isNaN(p) || $(p, i), l = x(), u = l + U, l > f || n ? d = f - R.horizontalGutter : f + r > u && (d = f - U + r + R.horizontalGutter), isNaN(d) || _(d, i)
            }
            ...
            function T() {
                W.unbind(kt).bind(kt, function (t, e, n, i) {
                    et || (et = 0), Q || (Q = 0);
                    var o = et, s = Q, r = t.deltaFactor || R.mouseWheelSpeed;
                    return wt.scrollBy(n * r, -i * r, !1), o == et && s == Q
                })
            }
            ...
            function P() {
                function n() {
                    ...
                    switch (i) {
                        case 40:
                            wt.scrollByY(R.keyboardSpeed, !1);
                            break;
                        case 38:
                            wt.scrollByY(-R.keyboardSpeed, !1);
                            break;
                        case 34:
                        case 32:
                            wt.scrollByY(B * R.scrollPagePercent, !1);
                            break;
                        case 33:
                            wt.scrollByY(-B * R.scrollPagePercent, !1);
                            break;
                        case 39:
                            wt.scrollByX(R.keyboardSpeed, !1);
                            break;
                        case 37:
                            wt.scrollByX(-R.keyboardSpeed, !1)
                    }
                ...
                var i, o, s = [];
                G && s.push(ct[0]), K && s.push(nt[0]), z.bind("focus.jsp", function () {
                    e.focus()
                    ...
                    if (e.target === this || s.length && t(e.target).closest(s).length) {
                        ...
                        return o = e.keyCode == i && r != et || a != Q, !o
                    }
                }).bind("keypress.jsp", function (e) {
                    return e.keyCode == i && n(), e.target === this || s.length && t(e.target).closest(s).length ? !o : void 0
                }), R.hideFocus ? (e.css("outline", "none"), "hideFocus" in W[0] && e.attr("hideFocus", !0)) : (e.css("outline", ""), "hideFocus" in W[0] && e.attr("hideFocus", !1))
            }
            ...
            function H() {
                if (location.hash && location.hash.length > 1) {
                    ...
                    e.length && z.find(i) && (0 === W.scrollTop() ? n = setInterval(function () {
                        W.scrollTop() > 0 && (j(e, !0), t(document).scrollTop(W.position().top), clearInterval(n))
                    }, 50) : (j(e, !0), t(document).scrollTop(W.position().top)))
                }
            }

            function I() {
                t(document.body).data("jspHijack") || (t(document.body).data("jspHijack", !0), t(document.body).delegate('a[href*="#"]', "click", function (e) {
                    var n, i, o, s, r, a, l = this.href.substr(0, this.href.indexOf("#")), c = location.href;
                    if (-1 !== location.href.indexOf("#") && (c = location.href.substr(0, location.href.indexOf("#"))), l === c) {
                        ...
                        i.length && (o = i.closest(".jspScrollable"), s = o.data("jsp"), s.scrollToElement(i, !0), o[0].scrollIntoView && (r = t(window).scrollTop(), a = i.offset().top, (r > a || a > r + t(window).height()) && o[0].scrollIntoView()), e.preventDefault())
                    }
                }))
            }
            ...
            function L() {
                var t, e, n, i, o, s = !1;
                W.unbind("touchstart.jsp touchmove.jsp touchend.jsp click.jsp-touchclick").bind("touchstart.jsp", function (r) {
                    var a = r.originalEvent.touches[0];
                    t = x(), e = k(), n = a.pageX, i = a.pageY, o = !1, s = !0
                }).bind("touchmove.jsp", function (r) {
                    if (s) {
                        var a = r.originalEvent.touches[0], l = et, c = Q;
                        return wt.scrollTo(t + n - a.pageX, e + i - a.pageY), o = o || Math.abs(n - a.pageX) > 5 || Math.abs(i - a.pageY) > 5, l == et && c == Q
                    }
            ...
            function M() {
                var t = k(), n = x();
                e.removeClass("jspScrollable").unbind(".jsp"), z.unbind(".jsp"), e.replaceWith(xt.append(z.children())), xt.scrollTop(t), xt.scrollLeft(n), gt && clearInterval(gt)
            }

            var R, z, U, B, W, Y, N, F, X, K, G, V, Z, Q, J, tt, et, nt, it, ot, st, rt, at, lt, ct, ut, pt, dt, ht, ft, gt, mt, vt, yt, wt = this, bt = !0, $t = !0, _t = !1, jt = !1, xt = e.clone(!1, !1).empty(), kt = t.fn.mwheelIntent ? "mwheelIntent.jsp" : "mousewheel.jsp";
            "border-box" === e.css("box-sizing") ? (mt = 0, vt = 0) : (mt = e.css("paddingTop") + " " + e.css("paddingRight") + " " + e.css("paddingBottom") + " " + e.css("paddingLeft"), vt = (parseInt(e.css("paddingLeft"), 10) || 0) + (parseInt(e.css("paddingRight"), 10) || 0)), t.extend(wt, {
                reinitialise: function (e) {
                    ...
                    wt.scrollByX(t, n), wt.scrollByY(e, n)
                }, scrollByX: function (t, e) {
                    var n = x() + Math[0 > t ? "floor" : "ceil"](t), i = n / (Y - U);
                    v(i * tt, e)
                }, scrollByY: function (t, e) {
                    var n = k() + Math[0 > t ? "floor" : "ceil"](t), i = n / (N - B);
                    g(i * Z, e)
    ...
    var i = {
        init: function (e, o) {
            ...
            e.nzWidth = e.$elem.width(), e.nzHeight = e.$elem.height(), e.nzOffset = e.$elem.offset(), e.widthRatio = e.largeWidth / e.nzWidth, e.heightRatio = e.largeHeight / e.nzHeight, "window" == e.options.zoomType && (e.zoomWindowStyle = "overflow: hidden;background-position: 0px 0px;background-color:white;text-align:center;width: " + String(e.options.zoomWindowWidth) + "px;height: " + String(e.options.zoomWindowHeight) + "px;float: left;display: none;z-index:100px;border: " + String(e.options.borderSize) + "px solid " + e.options.borderColour + ";background-repeat: no-repeat;position: absolute;"), "inner" == e.options.zoomType && (e.zoomWindowStyle = "overflow: hidden;background-position: 0px 0px;width: " + String(e.nzWidth) + "px;height: " + String(e.nzHeight) + "px;float: left;display: none;cursor:" + e.options.cursor + ";px solid " + e.options.borderColour + ";background-repeat: no-repeat;position: absolute;"), "window" == e.options.zoomType && (e.nzHeight < e.options.zoomWindowWidth / e.widthRatio ? lensHeight = e.nzHeight : lensHeight = String(e.options.zoomWindowHeight / e.heightRatio), e.largeWidth < e.options.zoomWindowWidth ? lensWidth = e.nzHWidth : lensWidth = e.options.zoomWindowWidth / e.widthRatio, e.lensStyle = "background-position: 0px 0px;width: " + String(e.options.zoomWindowWidth / e.widthRatio) + "px;height: " + String(e.options.zoomWindowHeight / e.heightRatio) + "px;float: right;display: none;overflow: hidden;z-index: 999;-webkit-transform: translateZ(0);opacity:" + e.options.lensOpacity + ";filter: alpha(opacity = " + 100 * e.options.lensOpacity + "); zoom:1;width:" + lensWidth + "px;height:" + lensHeight + "px;background-color:" + e.options.lensColour + ";cursor:" + e.options.cursor + ";border: " + e.options.lensBorder + "px solid black;background-repeat: no-repeat;position: absolute;"), e.tintStyle = "display: block;position: absolute;background-color: " + e.options.tintColour + ";filter:alpha(opacity=0);opacity: 0;width: " + e.nzWidth + "px;height: " + e.nzHeight + "px;", e.lensRound = "", "lens" == e.options.zoomType && (e.lensStyle = "background-position: 0px 0px;float: left;display: none;border: " + String(e.options.borderSize) + "px solid " + e.options.borderColour + ";width:" + String(e.options.lensSize) + "px;height:" + String(e.options.lensSize) + "px;background-repeat: no-repeat;position: absolute;"), "round" == e.options.lensShape && (e.lensRound = "border-top-left-radius: " + String(e.options.lensSize / 2 + e.options.borderSize) + "px;border-top-right-radius: " + String(e.options.lensSize / 2 + e.options.borderSize) + "px;border-bottom-left-radius: " + String(e.options.lensSize / 2 + e.options.borderSize) + "px;border-bottom-right-radius: " + String(e.options.lensSize / 2 + e.options.borderSize) + "px;"), e.zoomContainer = t('<div class="zoomContainer" style="-webkit-transform: translateZ(0);position:absolute;left:' + e.nzOffset.left + "px;top:" + e.nzOffset.top + "px;height:" + e.nzHeight + "px;width:" + e.nzWidth + 'px;"></div>'), t("body").append(e.zoomContainer), e.options.containLensZoom && "lens" == e.options.zoomType && e.zoomContainer.css("overflow", "hidden"), "inner" != e.options.zoomType && (e.zoomLens = t("<div class='zoomLens' style='" + e.lensStyle + e.lensRound + "'>&nbsp;</div>").appendTo(e.zoomContainer).click(function () {
                ...
                e.$elem.trigger("click")
            }), e.zoomWindowContainer = t("<div/>").addClass("zoomWindowContainer").css("width", e.options.zoomWindowWidth), e.zoomWindow.wrap(e.zoomWindowContainer), e.options.tint, "lens" == e.options.zoomType && e.zoomLens.css({backgroundImage: "url('" + e.imageSrc + "')"}), "window" == e.options.zoomType && e.zoomWindow.css({backgroundImage: "url('" + e.imageSrc + "')"}), "inner" == e.options.zoomType && e.zoomWindow.css({backgroundImage: "url('" + e.imageSrc + "')"}), e.$elem.bind("touchmove", function (t) {
                t.preventDefault();
            ...
            var e = this;
            return e.nzHeight = e.$elem.height(), e.nzWidth = e.$elem.width(), e.nzOffset = e.$elem.offset(), e.options.tint && (e.zoomTint.css({top: 0}), e.zoomTint.css({left: 0})), e.options.responsive && (e.nzHeight < e.options.zoomWindowWidth / e.widthRatio ? lensHeight = e.nzHeight : lensHeight = String(e.options.zoomWindowHeight / e.heightRatio), e.largeWidth < e.options.zoomWindowWidth ? lensWidth = e.nzHWidth : lensWidth = e.options.zoomWindowWidth / e.widthRatio, e.widthRatio = e.largeWidth / e.nzWidth, e.heightRatio = e.largeHeight / e.nzHeight, e.zoomLens.css({
            ...
            function o(t) {
                var e = "100%", o = "0px", n = {top: o, bottom: e, left: o, right: e};
                return n[t] || t
            }
            ...
            if (n.windowOffsetTop = n.windowOffsetTop + n.options.zoomWindowOffety, n.windowOffsetLeft = n.windowOffsetLeft + n.options.zoomWindowOffetx, n.zoomWindow.css({top: n.windowOffsetTop}), n.zoomWindow.css({left: n.windowOffsetLeft}), "inner" == n.options.zoomType && (n.zoomWindow.css({top: 0}), n.zoomWindow.css({left: 0})), n.windowLeftPos = String(-1 * ((e.pageX - n.nzOffset.left) * n.widthRatio - n.zoomWindow.width() / 2)), n.windowTopPos = String(-1 * ((e.pageY - n.nzOffset.top) * n.heightRatio - n.zoomWindow.height() / 2)), n.Etoppos && (n.windowTopPos = 0), n.Eloppos && (n.windowLeftPos = 0), n.Eboppos && (n.windowTopPos = -1 * (n.largeHeight - n.zoomWindow.height())), n.Eroppos && (n.windowLeftPos = -1 * (n.largeWidth - n.zoomWindow.width())), "window" == n.options.zoomType)if (n.widthRatio <= 1 && (n.windowLeftPos = 0), n.heightRatio <= 1 && (n.windowTopPos = 0), n.largeHeight < n.options.zoomWindowHeight && (n.windowTopPos = 0), n.largeWidth < n.options.zoomWindowWidth && (n.windowLeftPos = 0), n.options.easing) {
                ...
                if (t.support.bgPos = "3px 5px" === i.css("backgroundPosition") ? !0 : !1, t.support.bgPosXY = "3px" === i.css("backgroundPositionX") ? !0 : !1, i = null, t.support.bgPos && !t.support.bgPosXY) {
                    var s = "background-position", r = t.camelCase;
                    t.each(["x", "y"], function (e, n) {
                        var i = r(s + "-" + n);
                        t.cssHooks[i] = {
                            get: function (n) {
                                var i = t.css(n, s).split(/\s+/, 2);
                                return o(i[e])
                            }, set: function (n, i) {
                                var r = t.css(n, s).split(/\s+/, 2);
                                r[e] = o(i), t.style(n, s, r.join(" "))
                            }
...
!function (t) {
    t.extend({
        uploadPreview: function (e) {
            ...
            return window.File && window.FileList && window.FileReader ? void("undefined" != typeof t(o.input_field) && null !== t(o.input_field) && t(o.input_field).change(function () {
                var e = event.target.files, n = t(event.target).closest(o.preview_box), i = n.find(o.label_field);
                if (console.log(i), e.length > 0) {
                    var s = e[0], r = new FileReader;
                    r.addEventListener("load", function (t) {
                        var e = t.target;
                        s.type.match("image") ? (n.css("background-image", "url(" + e.result + ")"), n.css("background-size", "cover"), n.css("background-position", "center center")) : s.type.match("audio") ? n.html("<audio controls><source src='" + e.result + "' type='" + s.type + "' />Your browser does not support the audio element.</audio>") : alert("This file type is not supported yet.")
                    }), 0 == o.no_label && i.html(o.label_selected), r.readAsDataURL(s)
                } else 0 == o.no_label && i.html(o.label_default), n.css("background-image", "none"), n.find(audio).remove()
            })) : (console.log("You need a browser with file reader support, to use this form properly."), !1)
        }
    })
}(jQuery);
!function (t, e) {
    ...
    function t(t) {
        return function () {
            return !t.apply(null, d.call(arguments))
        }
    }

    function e(t) {
        return function () {
            var e = d.call(arguments), o = e.length;
            1 === o && a.array(e[0]) && (e = e[0], o = e.length);
            for (var n = 0; o > n; n++)if (!t.call(null, e[n]))return !1;
            return !0
        }
    }
    ...
    function o(t) {
        return function () {
            var e = d.call(arguments), o = e.length;
            1 === o && a.array(e[0]) && (e = e[0], o = e.length);
            for (var n = 0; o > n; n++)if (t.call(null, e[n]))return !0;
            return !1
        }
    }
    ...
    function i() {
        var n = a;
        for (var i in n)if (c.call(n, i) && a["function"](n[i]))for (var s = n[i].api || ["not", "all", "any"], r = 0; r < s.length; r++)"not" === s[r] && (a.not[i] = t(a[i])), "all" === s[r] && (a.all[i] = e(a[i])), "any" === s[r] && (a.any[i] = o(a[i]))
    }

    var s = this || global, r = s.is, a = {};
    a.VERSION = "0.8.0", a.not = {}, a.all = {}, a.any = {};
    var l = Object.prototype.toString, d = Array.prototype.slice, c = Object.prototype.hasOwnProperty;
    a.arguments = function (t) {
        return a.not["null"](t) && ("[object Arguments]" === l.call(t) || "object" == typeof t && "callee" in t)
        ...
        return a.nan(t) || a.nan(e) ? a.nan(t) === a.nan(e) : l.call(t) === l.call(e)
        ...
        return a.existy(t) && t !== !1 && a.not.nan(t) && "" !== t && 0 !== t
    }, a.falsy = t(a.truthy), a.space = function (t) {
        if (a["char"](t)) {
        ...
        return a.all.number(t, e) ? t === e && 1 / t === 1 / e : a.all.string(t, e) || a.all.regexp(t, e) ? "" + t == "" + e : a.all["boolean"](t, e) ? t === e : !1
    ...
    }, a.above.api = ["not"], a.under = function (t, e) {
        return a.all.number(t, e) && e > t
    }, a.under.api = ["not"], a.within = function (t, e, o) {
        return a.all.number(t, e, o) && t > e && o > t
    }, a.within.api = ["not"], a.decimal = function (t) {
        return a.number(t) && t % 1 !== 0
    }, a.integer = function (t) {
        return a.number(t) && t % 1 === 0
    }, a.finite = isFinite || function (t) {
            return t !== 1 / 0 && t !== -(1 / 0) && a.not.nan(t)
        }, a.infinite = t(a.finite);
    var u = {
    ...
    for (var p in u)u.hasOwnProperty(p) && n(p, u);
    a.include = function (t, e) {
        return t.indexOf(e) > -1
    }, a.include.api = ["not"], a.upperCase = function (t) {
    ...
    }, a.startWith.api = ["not"], a.endWith = function (t, e) {
        return a.string(t) && t.indexOf(e) > -1 && t.indexOf(e) === t.length - e.length
    }, a.endWith.api = ["not"], a.capitalized = function (t) {
        if (a.not.string(t))return !1;
        for (var e = t.split(" "), o = [], n = 0; n < e.length; n++)o.push(e[n][0] === e[n][0].toUpperCase());
        return a.all.truthy.apply(null, o)
    }, a.palindrome = function (t) {
        return a.string(t) && t == t.split("").reverse().join("")
    };
    var h = ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"], f = ["january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december"];
    if (a.today = function (t) {
            var e = new Date, o = e.toDateString();
            return a.date(t) && t.toDateString() === o
        }, a.yesterday = function (t) {
            var e = new Date, o = new Date(e.setDate(e.getDate() - 1)).toDateString();
            return a.date(t) && t.toDateString() === o
        ...
        }, a.future = t(a.past), a.day = function (t, e) {
            return a.date(t) && e.toLowerCase() === h[t.getDay()]
        }, a.day.api = ["not"], a.month = function (t, e) {
            return a.date(t) && e.toLowerCase() === f[t.getMonth()]
        }, a.month.api = ["not"], a.year = function (t, e) {
            return a.date(t) && a.number(e) && e === t.getFullYear()
        }, a.year.api = ["not"], a.leapYear = function (t) {
            return a.number(t) && (t % 4 === 0 && t % 100 !== 0 || t % 400 === 0)
        }, a.weekend = function (t) {
            return a.date(t) && (6 === t.getDay() || 0 === t.getDay())
        }, a.weekday = t(a.weekend), a.inDateRange = function (t, e, o) {
            if (a.not.date(t) || a.not.date(e) || a.not.date(o))return !1;
            var n = t.getTime(), i = e.getTime(), s = o.getTime();
            return n > i && s > n
        }, a.inDateRange.api = ["not"], a.inLastWeek = function (t) {
        ...
        }, a.quarterOfYear.api = ["not"], a.dayLightSavingTime = function (t) {
            var e = new Date(t.getFullYear(), 0, 1), o = new Date(t.getFullYear(), 6, 1), n = Math.max(e.getTimezoneOffset(), o.getTimezoneOffset());
            return t.getTimezoneOffset() < n
        }, "undefined" != typeof window) {
        var g = "navigator" in window && "userAgent" in navigator && navigator.userAgent.toLowerCase() || "", m = "navigator" in window && "vendor" in navigator && navigator.vendor.toLowerCase() || "", w = "navigator" in window && "appVersion" in navigator && navigator.appVersion.toLowerCase() || "";
        a.chrome = function () {
            return /chrome|chromium/i.test(g) && /google inc/.test(m)
        }, a.chrome.api = ["not"], a.firefox = function () {
            return /firefox/i.test(g)
        }, a.firefox.api = ["not"], a.edge = function () {
            return /edge/i.test(g)
        }, a.edge.api = ["not"], a.ie = function (t) {
            return t ? t >= 11 ? "ActiveXObject" in window : new RegExp("msie " + t).test(g) : /msie/i.test(g) || "ActiveXObject" in window
        }, a.ie.api = ["not"], a.opera = function () {
            return /^Opera\//.test(g) || /\x20OPR\//.test(g)
        }, a.opera.api = ["not"], a.safari = function () {
            return /safari/i.test(g) && /apple computer/i.test(m)
        }, a.safari.api = ["not"], a.ios = function () {
            return a.iphone() || a.ipad() || a.ipod()
        }, a.ios.api = ["not"], a.iphone = function () {
            return /iphone/i.test(g)
        }, a.iphone.api = ["not"], a.ipad = function () {
            return /ipad/i.test(g)
        }, a.ipad.api = ["not"], a.ipod = function () {
            return /ipod/i.test(g)
        }, a.ipod.api = ["not"], a.android = function () {
            return /android/i.test(g)
        }, a.android.api = ["not"], a.androidPhone = function () {
            return /android/i.test(g) && /mobile/i.test(g)
        }, a.androidPhone.api = ["not"], a.androidTablet = function () {
            return /android/i.test(g) && !/mobile/i.test(g)
        }, a.androidTablet.api = ["not"], a.blackberry = function () {
            return /blackberry/i.test(g) || /BB10/i.test(g)
        }, a.blackberry.api = ["not"], a.desktop = function () {
            return a.not.mobile() && a.not.tablet()
        }, a.desktop.api = ["not"], a.linux = function () {
            return /linux/i.test(w)
        }, a.linux.api = ["not"], a.mac = function () {
            return /mac/i.test(w)
        }, a.mac.api = ["not"], a.windows = function () {
            return /win/i.test(w)
        }, a.windows.api = ["not"], a.windowsPhone = function () {
            return a.windows() && /phone/i.test(g)
        }, a.windowsPhone.api = ["not"], a.windowsTablet = function () {
            return a.windows() && a.not.windowsPhone() && /touch/i.test(g)
        ...
        }, a.online.api = ["not"], a.offline = t(a.online), a.offline.api = ["not"], a.touchDevice = function () {
            return "ontouchstart" in window || "DocumentTouch" in window && document instanceof DocumentTouch
        }, a.touchDevice.api = ["not"]
    }
    return a.propertyCount = function (t, e) {
        if (!a.object(t) || !a.number(e))return !1;
        if (Object.keys)return Object.keys(t).length === e;
        var o, n = [];
        for (o in t)c.call(t, o) && n.push(o);
        return n.length === e
    }, a.propertyCount.api = ["not"], a.propertyDefined = function (t, e) {
        return a.object(t) && a.string(e) && e in t
    }, a.propertyDefined.api = ["not"], a.windowObject = function (t) {
        ...
        return !1
    }, a.inArray.api = ["not"], a.sorted = function (t) {
        if (a.not.array(t))return !1;
        for (var e = 0; e < t.length; e++)if (t[e] > t[e + 1])return !1;
        return !0
    }, i(), a.setRegexp = function (t, e) {
        for (var o in u)c.call(u, o) && e === o && (u[o] = t)
...
!function (t, e) {
    "use strict";
    function o(o, i) {
        this.$input = t(o), this.$rating = t("<span></span>").css({cursor: "default"}).insertBefore(this.$input), this.options = function (o) {
            return o.start = parseInt(o.start, 10), o.start = isNaN(o.start) ? e : o.start, o.stop = parseInt(o.stop, 10), o.stop = isNaN(o.stop) ? o.start + n || e : o.stop, o.step = parseInt(o.step, 10) || e, o.fractions = Math.abs(parseInt(o.fractions, 10)) || e, o.scale = Math.abs(parseInt(o.scale, 10)) || e, o = t.extend({}, t.fn.rating.defaults, o), o.filledSelected = o.filledSelected || o.filled, o
        }(t.extend({}, this.$input.data(), i)), this._init()
    }

    var n = 5;
    o.prototype = {
        _init: function () {
            for (var o = this, n = this.$input, i = this.$rating, s = function (t) {
                return function (o) {
                    n.prop("disabled") || n.prop("readonly") || n.data("readonly") !== e || t.call(this, o)
                }
                ...
                t('<div class="rating-symbol-background ' + this.options.empty + '"></div>').appendTo(a), t('<div class="rating-symbol-foreground"></div>').append("<span></span>").css({
                    ...
                    right: 0,
                    width: 0
                }).appendTo(a), i.append(a), this.options.extendSymbol.call(a, this._indexToRate(r))
            }
            this._updateRate(n.val()), n.on("change", function () {
                o._updateRate(t(this).val())
            });
            var l, d = function (e) {
                var n = t(e.currentTarget), i = Math.abs((e.pageX || e.originalEvent.touches[0].pageX) - (("rtl" === n.css("direction") && n.width()) + n.offset().left));
                return i = i > 0 ? i : .1 * o.options.scale, n.index() + i / n.width()
            };
            i.on("mousedown touchstart", ".rating-symbol", s(function (t) {
                n.val(o._indexToRate(d(t))).change()
            })).on("mousemove touchmove", ".rating-symbol", s(function (n) {
                var i = o._roundToFraction(d(n));
                i !== l && (l !== e && t(this).trigger("rating.rateleave"), l = i, t(this).trigger("rating.rateenter", [o._indexToRate(l)])), o._fillUntil(i)
            })).on("mouseleave touchend", ".rating-symbol", s(function () {
                l = e, t(this).trigger("rating.rateleave"), o._fillUntil(o._rateToIndex(parseFloat(n.val())))
            }))
        }, _fillUntil: function (t) {
            var e = this.$rating, o = Math.floor(t);
            e.find(".rating-symbol-background").css("visibility", "visible").slice(0, o).css("visibility", "hidden");
            var n = e.find(".rating-symbol-foreground");
            n.width(0), n.slice(0, o).width("auto").find("span").attr("class", this.options.filled), n.eq(t % 1 ? o : o - 1).find("span").attr("class", this.options.filledSelected), n.eq(o).width(t % 1 * 100 + "%")
            ...
            var e = Math.ceil(t % 1 * this.options.fractions) / this.options.fractions, o = Math.pow(10, this.options.scale);
            return Math.floor(t) + Math.floor(e * o) / o
        }, _contains: function (t) {
            var e = this.options.step > 0 ? this.options.start : this.options.stop, o = this.options.step > 0 ? this.options.stop : this.options.start;
            return t >= e && o >= t
        }, _updateRate: function (t) {
            var e = parseFloat(t);
            this._contains(e) && (this._fillUntil(this._rateToIndex(e)), this.$input.val(e))
        }, rate: function (t) {
        ...
        return this.each(function () {
            var s = t(this), r = s.data("rating");
            r || s.data("rating", r = new o(this, e)), "string" == typeof e && "_" !== e[0] && (n = r[e].apply(r, i))
        }), n || this
        ...
        t("input.rating-communication").rating()
        t("input.rating-shipment").rating()
        t("input.rating-description").rating()
    })
}(jQuery);
function open_homepage_menu() {
    var t = $(".uk-navbar-toggle-home[data-uk-toggle]");
    t.on("click", function () {
        $(window).scrollTop() < 380 && $("html,body").stop().animate({scrollTop: 380})
    })
}
function select_init() {
    $(".js-select").select2({minimumResultsForSearch: "-1"})
    makeAutocompleteBrands()
}
function callback() {
    $(function (t) {
        var e = t(".button-to-top");
        t(window).on("scroll", function () {
            e["fade" + (t(this).scrollTop() > 100 ? "In" : "Out")](500)
        })
    })
}
function scrollbar() {
    var t = {verticalDragMinHeight: 32, verticalDragMaxHeight: 32}, e = $(".scroll-pane");
    e.each(function () {
        var e = $(this);
        e.jScrollPane(t)
    });
...
function update_dropdown() {
    ...
    $(window).on("resize", function (e) {
        clearTimeout(t), t = setTimeout(function () {
            UIkit.dropdown(".filter-wrapper", {mode: "click", justify: "#dropdown-nav"}).checkDimensions()
        }, 150)
    })
}
function bag_init() {
...
function bag() {
    UIkit.dropdown(".dropdown-bag-wrapper", {mode: "hover", pos: "bottom-right"}).show()
}
function update_dropdown_bag() {
    $(window).on("resize", function () {
        UIkit.dropdown(".dropdown-bag-wrapper", {mode: "hover", pos: "bottom-right"}).checkDimensions()
    })
}
function navbar_toggle() {
    function t() {
        var t = window.innerHeight, o = i.data("uk-toggle"), n = UIkit.Utils.str2json(o);
        e = n.target;
        var s = $(".uk-navbar").height(), r = t - s;
        i.hasClass("active-menu") ? $(e).css("height", r + "px") : $(e).css("height", "")
    }

    var e, o = $(window), n = $("body"), i = $(".uk-navbar-toggle[data-uk-toggle]");
    i.on("click", function () {
        i.toggleClass("active-menu"), n.toggleClass("mobile-menu-open"), t()
    }), o.on("resize", function () {
        o.width() > 768 && ($(e).css("height", ""), i.removeClass("active-menu"), n.removeClass("mobile-menu-open")), t()
    })
}
function zoom_img() {
    $(".zoom").on("click", function () {
        $(this).hasClass("zoomed") ? ($(".zoomContainer").remove(), $(this).removeClass("zoomed")) : ($(this).elevateZoom({
            borderSize: 1,
            borderColour: "#b1b1b1"
...
function accordion_click() {
    var t = $(".account-wrapper"), e = t.find(".accordion-title"), o = t.find(".uk-accordion-title"), n = 0;
    e.on("click", function () {
        var t = $(this);
        t.hasClass("active") || o.eq(t.index()).trigger("click")
    }), t.on("toggle.uk.accordion", function () {
        o.filter(".uk-active").length || o.eq(n).trigger("click"), o.each(function (t) {
            return $(this).hasClass("uk-active") ? (n = t, !1) : void 0
        }), e.removeClass("active"), e.eq(n).addClass("active"), 1 == o.eq(n).data("account-edit") ? t.find(".edit-account-link").removeClass("uk-hidden") : t.find(".edit-account-link").addClass("uk-hidden")
    })
}
function thumb_click() {
    $link = $(".reduce-price"), $link.on("click", function () {
        var t = $(this), e = t.closest(".thumbnail-wrapper"), o = e.find(".thumbnail-click-block");
        return o.show(), !1
    })
}
...
function registration_select_init() {
    $("#User_country_id").select2({minimumResultsForSearch: "-1"})
}
function attributes_select_init() {
    $("#attributesBlock select").select2({minimumResultsForSearch: "-1"})
}
$(document).ready(function () {
    select_init(), callback(), scrollbar(), navbar_toggle(), is.desktop() && zoom_img(), accordion_click(), thumb_click(), upload_file(), bag_init(), update_dropdown_bag(), update_dropdown(), open_homepage_menu()
});

function makeAutocompleteBrands() {
    var id = "#Product_brand_id";
    var select = $(id);
    var name = select.attr('name');
    var val = select.val();
    var text = select.find('option:selected').text();
    var el = select.parent().find('span.select2-selection__rendered');
    
    if (typeof window.old_brand_value !== 'undefined') {
        val = window.old_brand_value;
        if (typeof window.old_brand_text !== 'undefined' && window.old_brand_text != '') {
            text = window.old_brand_text;
        } else {
            text = val;
        }
    }
    el.hide();
    el.before('<input id="_brand_text" maxlength="255" class="autocomplete-input" type="text" value="' + text + '" name="' + name + '_visible" />');
    el.before('<input id="_brand_value" type="hidden" value="' + val + '" name="' + name + '" />');
    
    select.parent().find('.select2-selection').off('keydown');

    $(id).off('change').on('change', function(event) {
        window.old_brand_text = select.find('option:selected').text();
        window.old_brand_value = select.val();
        $('#_brand_text').val(window.old_brand_text);
        $('#_brand_value').val(window.old_brand_value);
    });

    $('#_brand_text').off('paste keyup change').on('paste keyup change', function(event) {
        window.old_brand_value = $(this).val();
        window.old_brand_text = '';
        $('#_brand_value').val(window.old_brand_value);
    });
}

function getDataForAutocomplete(request, source) {
    var data = [];
    var term = request.term.toLowerCase();
    var regex = new RegExp( '(the\\s)', 'gi' );
    var clearTerm = $.trim(term.replace(regex, ''));

    for (var i in source) {
        var el = source[i];
        if (el.hasOwnProperty('label') && el.hasOwnProperty('value')) {
            var lowercaseLabel = el.label.toLowerCase();
            if (lowercaseLabel.indexOf(term) != -1 ||
                lowercaseLabel.indexOf(clearTerm) != -1) {
                data.push(el);
            }
        }
    }
