...
/** Magic method which allows read-only access to protected or private class properties
  ...
  * @return mixed */
    ...
    protected function checkUploadedFile(array $aFile=null) {
        ...
        if (!$img->initError && !$this->checkMinSize($img, $file['tmp_name']))
            return $this->label("The image height is too small. The minimum height is 600px");
    ...
    protected function checkMinSize($image, $file=null) {
