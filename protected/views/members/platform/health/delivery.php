...
?>
<h1>ISP Delivery for "<?=$model->domainname;?>"</h1>

<?php $this->renderPartial('_subnav', array('model' => $model)); ?>
<?php $this->renderPartial('/shared/platforms/delivery', array('model' => $model, 'dataProvider' => $dataProvider, 'date' => $date, 'total' => $total));
