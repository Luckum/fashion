...
?>
<h1>Delivery Reports for "<?=$model->domainname;?>"</h1>

<?php $this->renderPartial('_subnav', array('model' => $model)); ?>

<?php $this->renderPartial('/shared/platforms/reports', array('model' => $model, 'dataProvider' => $dataProvider, 'date' => $date, 'total' => $total)); ?>