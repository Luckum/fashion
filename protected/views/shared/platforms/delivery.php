...
var d1 = [" . str_replace(',', '', $total['scheduled']) . "];
var d2 = [" . str_replace(',', '', $total['queued']) . "];
var d3 = [" . str_replace(',', '', $total['sent']) . "];

var plot2 = jQuery.jqplot('" . $bar_chart_id . "', [d1, d2, d3], {
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'pager' => array('class' => 'CLinkPager', 'header' => '', 'pageSize' => '50', 'maxButtonCount' => 15, 'firstPageLabel' => '<<', 'lastPageLabel' => '>>', 'prevPageLabel' => '<', 'nextPageLabel' => '>', 'selectedPageCssClass' => 'active', 'htmlOptions' => array('class' => 'pagination')),
    'columns' => array(
        array('name' => "isp", 'header' => 'ISP', 'type' => 'url'),
        array('name' => "scheduled", 'header' => 'Scheduled', 'value' => 'UtilsHelper::formatNumber($data["scheduled"])'),
