...
class DataService {
	...
	echo '<br>URI: ';
	print_r($uri);
	$this->serviceContext->IppConfiguration->Logger->RequestLog->Log(TraceLevel::Info, print_r($uri, true));
       
        // Creates request parameters
        $requestParameters = $this->initPostRequest($entity, $uri);
	echo '<br>Params: ';
	print_r($requestParameters);
	$this->serviceContext->IppConfiguration->Logger->RequestLog->Log(TraceLevel::Info, print_r($requestParameters, true));
        ...
        try {
			...
			$this->serviceContext->IppConfiguration->Logger->RequestLog->Log(TraceLevel::Info, print_r($responseBody, true));			
